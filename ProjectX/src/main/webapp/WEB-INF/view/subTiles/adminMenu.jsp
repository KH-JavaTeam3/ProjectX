...
<header style="width: 80%"> <!-- 상단 메뉴바 크기 -->
	<div style="background-color: white;" align="left">
        ...
        <div class="1" style="margin-top: -17px; padding-left: 126px;">
			...
			<c:if test="${not empty sessionScope.memLogin}"><li class="liMenu" style="border-radius: 10px; background: #ABC2E8; right: -150px; top: 30px; position: absolute;"><c:if test="${sessionScope.memLogin.isAdmin != 'N' }"><a href="#">관리자 페이지</a></c:if></li> </c:if>

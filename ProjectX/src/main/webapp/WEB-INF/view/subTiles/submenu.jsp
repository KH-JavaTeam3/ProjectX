...
<div style="height: 46px;">
		<div class="col-md-12" align="center" style="line-height: 45px; padding: 0px;">
			...
			<div class="submenuBtn col-md-1" style="display: inline-block;" onclick="location.href='applyList.me'">
				<span style="font-size: 13px; color: white; font-weight: bold;">지원현황</span>
			</div>
...
<div style="height: 46px;">
		<div class="pointer col-md-12" align="center" style="line-height: 45px; padding: 0px;">
			...
			<div class="submenuBtn col-md-1" style="display: inline-block;" onclick="location.href='registHumanSeekerForm.co'">
				<span style="font-size: 13px; color: white; font-weight: bold;">공고 등록</span>
			</div>
			<div class="submenuBtn col-md-1" style="display: inline-block;" onclick="location.href='resumeInquiry.co'">
				<span style="font-size: 13px; color: white; font-weight: bold;">지원받은 이력서 조회</span>
			</div>
			...
			<div class="submenuBtn col-md-1" style="display: inline-block;" onclick="location.href='comMypage.co'">
...
for(var arr of noLogin){
	arr.addEventListener('click', () => alert('로그인이 필요한 메뉴입니다.'));
}
</script>
</html>
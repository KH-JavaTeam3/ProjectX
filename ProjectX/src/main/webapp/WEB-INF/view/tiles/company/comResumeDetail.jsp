...
<link rel="stylesheet" href="resources/css/resumeDetail.css?ver=12">
</head>
<body>
<input type="hidden" value="${memResume.comMypageNum }" id="comMypageNum">
<input type="hidden" value="${memResume.comName }" id="comName">
	<div style="height: 30px;"></div>
	<!-- 이력서 제목 -->
	<div class="mx-auto" style="border :3px solid #f1f3f9; width: 85%; position: relative; right: 14.5px;" >
		<div class="row">
			<span style="font-size: 27px; color: #222; font-weight: bold; font-family: 'Recipekorea'; position: relative; left: 27px;">${memResume.resumeName }</span>
		</div>
	</div>
	<br>
	...
	<div class="" style="border-bottom : 3px solid #f1f3f9; border-top : 3px solid #f1f3f9; width: 100%;" >
		<div class="col-md-12" style="padding-top: 20px; padding-left: 0px; padding-right: 0px; background: #fcfcfc;" align="left">
				...
				<div class="col-md-8">
						<span style="font-size: 23px; font-weight: bold; font-family: 'paybooc-Bold';">개인정보</span>
						...
						<div class="col-md-6" style="padding-bottom: 5px; padding-top: 20px;"align="left">
							...
							<colgroup>
								...
								<tr>
									...
									<td>${memResume.memInfoVO.memName }</td>
								</tr>
								<tr>
									<td style="color: gray;">이메일</td>
									<td id="memEmailForCom">${memResume.memInfoVO.memEmail }</td>
								</tr>
								<tr>
									<td style="color: gray;">생년월일</td>
									<td>${memResume.memInfoVO.memBirth }</td>
								</tr>
							</table>
						</div>
						<div class="col-md-6" style="margin-left: -40px; padding-bottom: 20px; padding-top: 20px;"align="left">
							...
							<colgroup>
								...
								<tr>
									...
									<td>
										<c:if test="${memResume.memInfoVO.memGender eq 'M' }">남성</c:if>
										<c:if test="${memResume.memInfoVO.memGender eq 'W' }">여성</c:if>
									</td>
								</tr>
								<tr>
									<td style="color: gray;">연락처</td>
									<td  >${memResume.memInfoVO.memTel1 }</td>
								</tr>
								<tr>
									<td style="color: gray;">주소</td>
									<td>${memResume.memInfoVO.memAddr }</td>
								</tr>
							</table>
						</div>
					</div>
...
<%-- 							<img id="preview" src="resources/images/memberProfile/${sessionScope.memLogin.memImage }" onerror="this.src='resources/images/profile.png'"> --%>
							<img id="preview" src="https://findream.s3.ap-northeast-2.amazonaws.com/images/${memResume.memInfoVO.memImage }" onerror="this.src='resources/images/profile.png'">
						</div>
					</div>
				</div>
				</div>
		...
		<div class="row" style="border-bottom : 3px solid #f1f3f9;border-top : 3px solid #f1f3f9; width: 100%; " >
			...
			<span style="font-size: 23px; font-weight: bold; font-family: 'paybooc-Bold';">경력사항</span>
				<c:forEach items="${memResume.careerList }" var="car" varStatus="status">
					<div class="row" style="width: 100%; margin-top: 10px; margin-left:0px; margin-right:0px; " >
						<div class="col-md-7" style="padding-bottom: 5px; padding-top: 20px;"align="left">
							<c:if test="${status.index ge 1 }">
								<div class="div"></div>
							</c:if>
									<table>
...
<script src="resources/js/comResumeDetail.js?ver=11"></script>
</html>
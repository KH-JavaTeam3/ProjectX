...
CREATE TABLE MEM_RESUME(
    ...
    EDU_GRADE       VARCHAR2(10) NOT NULL,
    EDU_SCHOOL      VARCHAR2(20) NOT NULL,
    EDU_LOC         VARCHAR2(20) NOT NULL,
    EDU_TYPE        VARCHAR2(20) NOT NULL,
    EDU_MAJOR       VARCHAR(20)  NOT NULL,
    EDU_BEGIN_DATE  VARCHAR2(20) NOT NULL,
    EDU_END_DATE    VARCHAR2(20) NULL,
    EDU_IS_OVER     VARCHAR2(20) NULL,
    EDU_SCORE       NUMBER       NULL,
    BE_COMPANY      VARCHAR2(30) NOT NULL,
    BE_CAREER       NUMBER       NOT NULL,
    BE_TYPE         VARCHAR2(20) NOT NULL,
    BE_POSITION     VARCHAR2(20) NOT NULL,
    HOPE_TYPE       VARCHAR2(20) DEFAULT '없음',
    HOPE_SAL        NUMBER       DEFAULT '0',
    HOPE_LOC        VARCHAR2(20) DEFAULT '없음',
...
CREATE TABLE LICENSE(
    ...
    LIC_LOC VARCHAR2(20) NOT NULL,
    LIC_GRADE VARCHAR2(20) NOT NULL,

...
CREATE TABLE MEM_INFO(
    ...
    MEM_AGE          VARCHAR2(30)    NOT NULL,
    MEM_GENDER       VARCHAR2(30)    NOT NULL, 
    MEM_BIRTH        DATE            NOT NULL,
    MEM_TEL1         VARCHAR2(30)    NOT NULL, 
    MEM_TEL2         VARCHAR2(30)    NULL, 
    MEM_ADDR         VARCHAR2(100)   NOT NULL, 
    DEL_YN           VARCHAR2(30)    DEFAULT 'N',
    MEM_JOIN_DATE    DATE            DEFAULT SYSDATE,
    IS_ADMIN         VARCHAR(30)     DEFAULT 'N',
...
CREATE TABLE MEM_RESUME(
    ...
    EDU_GRADE       VARCHAR2(30) NOT NULL,
    EDU_SCHOOL      VARCHAR2(30) NOT NULL,
    EDU_LOC         VARCHAR2(30) NOT NULL,
    EDU_TYPE        VARCHAR2(100) NOT NULL,
    EDU_MAJOR       VARCHAR(30)  NOT NULL,
    EDU_BEGIN_DATE  VARCHAR2(30) NOT NULL,
    EDU_END_DATE    VARCHAR2(30) NULL,
    EDU_IS_OVER     VARCHAR2(30) NULL,
    EDU_SCORE       NUMBER       NULL,
    BE_COMPANY      VARCHAR2(30) NOT NULL,
    BE_CAREER       NUMBER       NOT NULL,
    BE_TYPE         VARCHAR2(30) NOT NULL,
    BE_POSITION     VARCHAR2(30) NOT NULL,
    HOPE_TYPE       VARCHAR2(30) DEFAULT '없음',
    HOPE_SAL        NUMBER       DEFAULT '0',
    HOPE_LOC        VARCHAR2(30) DEFAULT '없음',
    HOPE_TIME       VARCHAR2(30) DEFAULT '주 5일',
    MEM_EMAIL       VARCHAR2(30) NOT NULL,
...
CREATE TABLE LICENSE(
    LIC_NUM NUMBER NULL,
    LIC_NAME VARCHAR2(30) NOT NULL,
    LIC_LOC VARCHAR2(30) NOT NULL,
    LIC_GRADE VARCHAR2(30) NOT NULL,
